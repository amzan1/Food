...
namespace Food.Controllers
{
    public class TestimonialsController : Controller
    {
        ...
        {
            ViewData["UserId"] = new SelectList(_context.Users, "UserId", "UsernameS");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("TestimonialId,UserId,TestimonialText,TestimonialStatus")] Testimonial testimonial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("TestimonialId,UserId,TestimonialText,TestimonialStatus")] Testimonial testimonial)
        {
